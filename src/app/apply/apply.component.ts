...
export class ApplyComponent implements OnInit {
    ...
    public refundInvoiceList: Array<any> = [{}];
    ...
    public percentageRefund: number;
    ...
    public success_inform: String;
    public currencyConvertUM = false;
    public reservedRoomsListOrig: Array<any> = [{}];
    public reservedRoomsListExtend: Array<any> = [{}];
    ...
    private mimeTypeInvoice: Array<string> = [
        'application/pdf'
    ];
    public AppSettings;
    public error_code = {
    ...
    @ViewChild('listInvoicesModal') public listInvoicesModal: ModalDirective;
    @ViewChild('listExtensionInvoicesModal') public listExtensionInvoicesModal: ModalDirective;
    @ViewChild('listRefundInvoicesModal') public listRefundInvoicesModal: ModalDirective;
    ...
    //check if convert currency under maintenance
    public currencyUnderMaintenance() {
        this.applyService.checkCurrencyUnderMaintenance().subscribe(res => {
            let convertCurrencyUM = res.json();
            if(convertCurrencyUM['response']) {
                this.currencyConvertUM = true;
            }
        });
    }
            ...
            this.applyService.getInvoiceDiscountList(apply_id, invoice_number).subscribe((result) => {
                ...
                if (this.invoiceDiscountList) {
                    ...
                    this.applyService.updateApplyDiscount(apply_id, this.totalInvoice).subscribe(
                        res => {
                            let rs = res.json();
                            this.success_inform = "SUCCESS";
                            setTimeout(()=>{ this.success_inform = ""; }, 5000);
                            this.search();
                            this.getApplyInvoice(apply_id, invoice_number);
        ...
        this.applyService.createInvoiceDiscount(apply_id, Math.round(discount), encodeURIComponent(reason), invoice_number).subscribe(res => {
            this.applyService.getInvoiceDiscountList(apply_id, invoice_number).subscribe((result) => {
                ...
                if (this.invoiceDiscountList) {
                    ...
                    this.applyService.updateExtensionInvoiceDiscount(apply_id, invoice_number, this.totalInvoice).subscribe(
                        res => {
                            let rs = res.json();
                            this.success_inform = "SUCCESS";
                            setTimeout(()=>{ this.success_inform = ""; }, 5000);
                            this.search();
                            this.getApply(apply_id);
                            this.getExtensionInvoice(apply_id, invoice_number);
                            this.processing = false;
                        });
                }
            });
                ...
                if (this.invoiceDiscountList) {
                    ...
                    this.applyService.updateRefundInvoiceDiscount(apply_id, this.totalInvoice).subscribe(
                        res => {
                            ...
                            this.search();
                            this.getApply(apply_id);
                            this.getApplyInvoice(apply_id, this.invoiceModel.invoice_number);
                            this.getInvoiceDiscountList(apply_id, this.invoiceModel.invoice_number);
                            this.loadReservedRooms(apply_id);
                            this.loadCondoReservedRooms(apply_id);
                            this.loadHotelsReservedRooms(apply_id);
                            this.loadWalkinReservedRooms(apply_id);
                            this.loadReservedRoomsLogs(apply_id);
                            this.loadReservedHotels(apply_id);
                            this.loadCourses(apply_id);
                            this.loadCourseLogs(apply_id);
                            this.getRefundInvoice(apply_id, invoice_number);
                            this.processing = false;
                        });
                }
            });
    ...
    public removeInvoiceDiscount(applyId, id, invoiceNumber, discountAmount) {
        ...
        this.applyService.deleteInvoiceDiscount(applyId, id, invoiceNumber, discountAmount).subscribe(res => {
            ...
            this.search();
            this.getInvoiceDiscountList(applyId, invoiceNumber);
            this.getApplyInvoice(applyId, invoiceNumber);
            this.processing = false;
        });
    }
    ...
    public removeExtInvoiceDiscount(applyId, id, invoiceNumber, discountAmount) {
        ...
        this.applyService.deleteExtInvoiceDiscount(applyId, id, invoiceNumber, discountAmount).subscribe(res => {
            ...
            this.invoiceDiscountByPercentage = new InvoiceDiscountModel();
            this.search();
            this.getExtensionInvoice(applyId, invoiceNumber);
            this.processing = false;
        });
    }
    ...
    public removeRfdInvoiceDiscount(applyId, id, invoiceNumber, discountAmount) {
        ...
        this.applyService.deleteRfdInvoiceDiscount(applyId, id, invoiceNumber, discountAmount).subscribe(res => {
            ...
            this.invoiceDiscountByPercentage = new InvoiceDiscountModel();
            this.search();
            this.getRefundInvoice(applyId, invoiceNumber);
            this.processing = false;
        });
    }
    ...
    public saveExtensionInvoiceCommission(apply_id, invoice_number, commission) {
        this.processing = true;
        ...
        this.applyService.updateApplyExtensionInvCommission(apply_id, invoice_number, this.extensionInvoice.ext_agent_commission, this.extensionInvoice.ext_commission_percentage).subscribe(
            res => {
                let rs = res.json();
                this.success_inform = "SUCCESS";
                setTimeout(()=>{ this.success_inform = ""; }, 5000);
                this.search();
                this.getExtensionInvoiceFromStudentApply(apply_id, invoice_number);
                this.processing = false;
    ...
    public saveRefundInvoiceCommission(apply_id, commission) {
        ...
        this.applyService.updateApplyRefundInvCommission(apply_id, this.refundInvoice.rfd_agent_commission, this.refundInvoice.rfd_commission_percentage).subscribe(
            res => {
                ...
                setTimeout(()=>{ this.success_inform = ""; }, 5000);
                this.search();
                this.getRefundInvoiceFromStudentApply(apply_id);
                this.processing = false;
                this.percentageCommission = null;
            });
    ...
    public saveRefundInvoiceAllTotal(apply_id, refund, condition, reason) {
        this.processing = true;
        let refundDiscount;
        if(condition == 1) {
            refundDiscount = this.refundInvoice.rfd_all_total_discount = Math.round(refund);
        } else if(condition == 2) {
            refundDiscount = this.refundInvoice.rfd_alltotal_discount_student = Math.round(refund);
        } else {
            refundDiscount = this.refundInvoice.rfd_totalamount_input = Math.round(refund);
        }
        this.refundInvoice.rfd_alltotal_amount_percentage = this.percentageRefund?this.percentageRefund * 100:0;
        // this.refundInvoice.rfd_refund_reason = (encodeURIComponent(reason) !== '') ? encodeURIComponent(reason): '';
        this.applyService.updateApplyRefundInvDiscount(apply_id, refundDiscount, this.refundInvoice.rfd_alltotal_amount_percentage, condition, encodeURIComponent(reason)).subscribe(
            res => {
                let rs = res.json();
                this.success_inform = "SUCCESS";
                this.refundInvoice.rfd_refund_reason = '';
                setTimeout(()=>{ this.success_inform = ""; }, 5000);
                this.search();
                this.getRefundInvoiceFromStudentApply(apply_id);
                this.processing = false;
                this.percentageRefund = null;
            });
    }
    ...
    public openEditExtensionInvoice(id, invoiceId) {
        if (id != 0) {
            this.getApply(id);
            this.getExtensionInvoiceFromStudentApply(id, invoiceId);
        } else {
    ...
    onChangeSelectPDFInvoice(event) {
        if (event.srcElement) {
            this.file = event.srcElement.files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-invoice').value;
        } else {
            this.file = this._elementRef.nativeElement.querySelector('#upload-pdf-invoice').files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-invoice').value;
        }
    }

    onChangeSelectPDFExtInvoice(event) {
        if (event.srcElement) {
            this.file = event.srcElement.files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-ext-invoice').value;
        } else {
            this.file = this._elementRef.nativeElement.querySelector('#upload-pdf-ext-invoice').files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-ext-invoice').value;
        }
    }

    onChangeSelectPDFRfdInvoice(event) {
        if (event.srcElement) {
            this.file = event.srcElement.files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-rfd-invoice').value;
        } else {
            this.file = this._elementRef.nativeElement.querySelector('#upload-pdf-rfd-invoice').files[0];
            this.filePath = this._elementRef.nativeElement.querySelector('#upload-pdf-rfd-invoice').value;
        }
    }
    ...
    public uploadInvoiceFile(applyId) {
        this.processing = true;
        if (this.file) {
            if (this.mimeTypeInvoice.indexOf(this.file.type) > -1) {
                this.isModalShown = true;
                this.applyService.uploadInvoiceData(this.file, applyId).subscribe(
                    (res) => {
                        this.import_success = true;
                        this.isModalShown = false;
                        this.processing = false;
    ...
    public downloadInvoiceFile(applyId, invoiceId) {
        this.processing = true;
        this.filterObj = {
            "passportName": this.passportName,
            "checkIn": this.checkIn,
        ...
        this.applyService.downloadInvoiceData(this.filterObj, applyId).delay(300).subscribe(
            res => {
                this.isModalShown = false;
                this.blobFile = res;
                this.pDownloadFile(res, "INVOICE-" + invoiceId + ".pdf");
                this.processing = false;
            },
            error => {
                this.isModalShown = false;
    ...
    public uploadExtInvoiceFile(invoiceId) {
        this.processing = true;
        if (this.file) {
            if (this.mimeTypeInvoice.indexOf(this.file.type) > -1) {
                this.isModalShown = true;
                this.applyService.uploadExtensionInvoiceData(this.file, invoiceId).subscribe(
                    (res) => {
                        this.import_success = true;
                        this.isModalShown = false;
                        this.processing = false;
                        this.success_inform = "SUCCESS";
                        this.closeListExtensionInvoices();
                        this.search();
                    },
                    (error) => {
                        this.import_success = false;
    ...
    public downloadExtInvoiceFile(invoiceId) {
        this.processing = true;
        this.filterObj = {
            "passportName": this.passportName,
            "checkIn": this.checkIn,
        ...
        this.applyService.downloadExtensionInvoiceData(this.filterObj, invoiceId).delay(300).subscribe(
            res => {
                this.isModalShown = false;
                this.blobFile = res;
                this.pDownloadFile(res, "EXT_INVOICE-" + invoiceId + ".pdf");
                this.processing = false;
            },
            error => {
                this.isModalShown = false;
    ...
    public uploadRfdInvoiceFile(invoiceId) {
        this.processing = true;
        if (this.file) {
            if (this.mimeTypeInvoice.indexOf(this.file.type) > -1) {
                this.isModalShown = true;
                this.applyService.uploadRefundInvoiceData(this.file, invoiceId).subscribe(
                    (res) => {
                        this.import_success = true;
                        this.isModalShown = false;
                        this.processing = false;
    ...
    public downloadRfdInvoiceFile(invoiceId) {
        this.processing = true;
        this.filterObj = {
            "passportName": this.passportName,
            "checkIn": this.checkIn,
        ...
        this.applyService.downloadRefundInvoiceData(this.filterObj, invoiceId).delay(300).subscribe(
            res => {
                this.isModalShown = false;
                this.blobFile = res;
                this.pDownloadFile(res, "RFD_INVOICE-" + invoiceId + ".pdf");
                this.processing = false;
            },
            error => {
                this.isModalShown = false;
    ...
    public loadListInvoices(id) {
        if (id != 0) {
            this.getApply(id);
            this.applyService.getInvoicesList(id).subscribe((res) => {
                this.invoiceList = res.json();
            });
        }
        if(this.currencyConvertUM) {
            alert("Sorry, the currency API servers in maintenance mode. Please kindly wait for it.");
        } else {
            this.listInvoicesModal.show();
        }
    }

    public closeListInvoices() {
        this.listInvoicesModal.hide();
        this.filePath = null;
        this.file = null;
        this.success_inform = null;
    }

    public loadListExtensionInvoices(id) {
        if (id != 0) {
            this.getApply(id);
            this.applyService.getExtInvoicesList(id).subscribe((res) => {
                this.extensionInvoiceList = res.json();
            });
        }
        if(this.currencyConvertUM) {
            alert("Sorry, the currency API servers in maintenance mode. Please kindly wait for it.");
        } else {
            this.listExtensionInvoicesModal.show();
        }
    }

    public closeListExtensionInvoices() {
        this.listExtensionInvoicesModal.hide();
        this.filePath = null;
        this.file = null;
        this.success_inform = null;
    }

    public extensionInvoiceSend(id, invoiceId) {
        if (id != 0) {
            this.getApply(id);
    ...
    public loadListRefundInvoices(id) {
        if (id != 0) {
            this.getApply(id);
            this.applyService.getRfdInvoicesList(id).subscribe((res) => {
                this.refundInvoiceList = res.json();
            });
        }
        if(this.currencyConvertUM) {
            alert("Sorry, the currency API servers in maintenance mode. Please kindly wait for it.");
        } else {
            this.listRefundInvoicesModal.show();
        }
    }

    public closeListRefundInvoices() {
        this.listRefundInvoicesModal.hide();
        this.filePath = null;
        this.file = null;
        this.success_inform = null;
    }

    public refundInvoiceSend(id, refundInvoiceId, originalInvoiceId) {
        if (id != 0) {
            this.getApply(id);
        ...
        this.applyService.getApply(id).subscribe(
            res => {
                ...
                this.saveDataLoadEvent = {
                    ...
                    selectCheckIn_date: this.setNgxDatepickerModel(new Date(this.studentApply.checkin_date)),
                    selectCheckOut_date: this.setNgxDatepickerModel(new Date(this.studentApply.checkout_date)),
                    selectExtCheckIn_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_checkin_date?new Date(this.extensionInvoice.ext_checkin_date):new Date()),
                    selectExtCheckOut_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_checkout_date?new Date(this.extensionInvoice.ext_checkout_date):new Date()),
                    selectExtEntrance_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_entrance_date?new Date(this.extensionInvoice.ext_entrance_date):new Date()),
                    selectExtGraduate_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_graduation_date?new Date(this.extensionInvoice.ext_graduation_date):new Date()),
                    selectExtDue_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_due_date?new Date(this.extensionInvoice.ext_due_date):new Date()),
                    selectRfdCheckIn_date: this.setNgxDatepickerModel(this.refundInvoice.rfd_checkin_date?new Date(this.refundInvoice.rfd_checkin_date):new Date(this.studentApply.checkin_date)),
                    selectRfdCheckOut_date: this.setNgxDatepickerModel(this.refundInvoice.rfd_checkout_date?new Date(this.refundInvoice.rfd_checkout_date):new Date(this.studentApply.checkout_date)),
                };
    ...
    private getExtensionInvoiceFromStudentApply(applyId, invoiceId) {
        this.applyService.getExtenionInvoice(applyId, invoiceId).subscribe(
            res => {
                let cloneObj = _.clone(res.json());
                ...
                this.saveDataLoadEvent = {
                    ...
                    checkIn_date: this.setNgxDatepickerModel(new Date(this.studentApply.checkin_date)),
                    checkOut_date: this.setNgxDatepickerModel(new Date(this.studentApply.checkout_date)),
                    start_date: this.setNgxDatepickerModel(new Date(this.extensionInvoice.ext_entrance_date?
                        this.extensionInvoice.ext_entrance_date : this.studentApply.entrance_date)),
                    graduate_date: this.setNgxDatepickerModel(new Date(this.extensionInvoice.ext_graduation_date?
                        this.extensionInvoice.ext_graduation_date : this.studentApply.graduation_date)),
                    paid_date: this.setNgxDatepickerModel(this.studentApply.paid_date?new Date(this.studentApply.paid_date):this.getDayAWeekBeforeArrival(new Date(this.studentApply.checkin_date))),
                    due_date: this.setNgxDatepickerModel(this.extensionInvoice.ext_due_date?new Date(this.extensionInvoice.ext_due_date):new Date()),
                    arrive_date: this.setNgxDatepickerModel(new Date(this.studentApply.arrival_date)),
                    invoice_checkin: this.setNgxDatepickerModel(new Date(this.invoiceModel.checkin_date)),
                    invoice_checkout: this.setNgxDatepickerModel(new Date(this.invoiceModel.checkout_date)),
                    approved_date: this.setNgxDatepickerModel(this.invoiceModel.approved_date?new Date(this.invoiceModel.approved_date):new Date()),
        ...
        this.applyService.getExtenionInvoicePhpRate(applyId, invoiceId).subscribe((res) => {
    ...
    private getExtensionInvoice(applyId,invoiceId) {
        ...
        this.applyService.getExtenionInvoice(applyId, invoiceId).subscribe(
            res => {
                ...
                this.loadReservedRoomsExtend(applyId);
            })
    ...
    public saveRefundInvoice() {
        ...
        this.refundInvoice.rfd_checkin_date = moment(this.saveDataLoadEvent.selectRfdCheckIn_date.jsdate).format('YYYY-MM-DD');
        this.refundInvoice.rfd_checkout_date = moment(this.saveDataLoadEvent.selectRfdCheckOut_date.jsdate).format('YYYY-MM-DD');
    ...
    public saveExtensionInvoice() {
        ...
        this.extensionInvoice.ext_checkin_date = moment(this.saveDataLoadEvent.selectExtCheckIn_date.jsdate).format('YYYY-MM-DD');
        this.extensionInvoice.ext_checkout_date = moment(this.saveDataLoadEvent.selectExtCheckOut_date.jsdate).format('YYYY-MM-DD');
        this.extensionInvoice.ext_entrance_date = moment(this.saveDataLoadEvent.selectExtEntrance_date.jsdate).format('YYYY-MM-DD');
        this.extensionInvoice.ext_graduation_date = moment(this.saveDataLoadEvent.selectExtGraduate_date.jsdate).format('YYYY-MM-DD');
        this.extensionInvoice.ext_due_date = moment(this.saveDataLoadEvent.selectExtDue_date.jsdate).format('YYYY-MM-DD');
    ...
    public loadReservedRooms(applyId) {
        this.applyService.getReservedRoomsList(applyId).subscribe((res) => {
            const reservedRoomsListOrig = res.json();

            this.reservedRoomsListOrig = reservedRoomsListOrig;

            const rrlo = reservedRoomsListOrig;

            const data_list = [];

            for (const rlist of reservedRoomsListOrig) {
                const from = Date.parse(rlist.date_from);
                const checkoutDate = Date.parse(moment(this.saveDataLoadEvent.selectCheckOut_date.jsdate).format('YYYY-MM-DD'));
                if (from > checkoutDate) {
                    data_list.push(rlist.date_from);
                }
            }

            let y = rrlo.length;
            while (y--) {
                if (data_list.indexOf(rrlo[y].date_from) != -1) {
                    rrlo.splice(y, 1);
                }
            }
    ...
    // get Reserved rooms list
    public loadReservedRoomsExtend(applyId) {
        this.applyService.getReservedRoomsList(applyId).subscribe((res) => {
            const reservedRoomsListExtend = res.json();

            this.reservedRoomsListExtend = reservedRoomsListExtend;
            const rrle = reservedRoomsListExtend;

            const data_list_extend_out = [];

            for (const rlistext of reservedRoomsListExtend) {
                const to = Date.parse(rlistext.date_to);
                const checkinDateExt = Date.parse(this.extensionInvoice.ext_checkin_date);
                const checkoutDateExt = Date.parse(this.extensionInvoice.ext_checkout_date);
                if( (to >= checkinDateExt) && (to <= checkoutDateExt) ) {
                    this.reservedRoomsListExtend = reservedRoomsListExtend;
                } else {
                    data_list_extend_out.push(rlistext.date_to);
                }
            }

            let z = rrle.length;
            while (z--) {
                if (data_list_extend_out.indexOf(rrle[z].date_to) != -1) {
                    rrle.splice(z, 1);
                }
            }
        });
    ...
    public lockExtInvoice(id, invoiceNumber) {
        this.processing = true;
        if (id) {
            this.loading = true;
            this.applyService.updateIsExtInvoiceConfirmedFlag(id, invoiceNumber, this.invoiceExtLock).subscribe(
                res => {
                    let rs = res.json();
                    this.extensionInvoiceModal.hide();
                    this.listExtensionInvoicesModal.hide();
    ...
    public unlockExtInvoice(id, invoiceNumber) {
        this.processing = true;
        if (id) {
            this.loading = true;
            this.applyService.updateIsExtInvoiceConfirmedFlag(id, invoiceNumber, this.invoiceExtUnlock).subscribe(
                res => {
                    let rs = res.json();
                    this.extensionInvoiceModal.hide();
                    this.listExtensionInvoicesModal.hide();
    ...
    public addExtensionInvoice(id) {
        this.processing = true;
        if (id) {
            this.loading = true;
            this.applyService.addExtensionInvoice(id).subscribe(
                res => {
                    let rs = res.json();
                    this.listExtensionInvoicesModal.hide();
                    this.search();
    ...
    public addRefundInvoice(id) {
        this.processing = true;
        if (id) {
            this.loading = true;
            this.applyService.addRefundInvoice(id).subscribe(
                res => {
                    let rs = res.json();
                    this.listRefundInvoicesModal.hide();
                    this.search();
    ...
    public removeExtendedInvoiceNo(applyId, invoiceId){
        this.applyService.deleteExtendedInvoiceNumber(applyId, invoiceId).subscribe(res => {
            let rs = res.json();
            this.editExtensionInvoiceModal.hide();
            this.listExtensionInvoicesModal.hide();
            this.processing = false;
    ...
    public removeRefundInvoiceNo(applyId){
        this.applyService.deleteRefundInvoiceNumber(applyId).subscribe(res => {
            let rs = res.json();
            this.editRefundInvoiceModal.hide();
            this.processing = false;
            this.search();
    ...
    public printRfdInvoice(country_code, gender, agent_name, passport_name, refund_invoice_number, rfd_checkin_date, rfd_checkout_date, rfd_term, rfd_building_id,
                           ...
                           reservedHotelsRoomsList,reservedWalkinRoomsList,commissionReason,approved_date,rfd_alltotal_amount_percentage,rfd_totalamount_input,rfd_alltotal_discount_student,rfd_alltotal_amount_discount,rfd_refund_reason) {

        let printContentsConfirmationPage, popupWin, roomType, refundType;
        ...
        let subTotalNonJPDollarsOrig, totalInvoiceNonJPDollarsOrig, totalAgent, totalDirect, subTotalDollarsOrigJP, totalInvoiceDollarsOrigJP, totalAgentJP, totalDirectJP, totalRefundDirect, totalRefundAgent, totalAgentJPRefund, totalDirectJPRefund;
        ...
        let accomoName, accomoCondoName, reservedAccomoRoomtype, accommodationHotelOthers, reservedAccomoWalkinRoomtype,
            reservedAccomoHotel, courseStudent, reservedAccomoCondoRoomtype, reservedAccomoHotelsRoomtype,currency;
        ...
        totalRefundDirect = ((rfd_alltotal_amount_percentage == 0)? (((entrance_fee + holiday_fee + transfer_fee + sub_total - discount) -
            (rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_tuition_accommodation_fee + rfd_plan_upgrade_fee + rfd_other1_fee + rfd_other2_fee - rfd_discount)) - rfd_totalamount_input) : rfd_alltotal_discount_student);
        totalRefundAgent = ((rfd_alltotal_amount_percentage == 0)? ( (((entrance_fee + holiday_fee + transfer_fee + sub_total) - (commission + discount)) -
            ((rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_tuition_accommodation_fee + rfd_plan_upgrade_fee + rfd_other1_fee + rfd_other2_fee) - (rfd_agent_commission + rfd_discount))) - rfd_totalamount_input) : rfd_alltotal_amount_discount);

        subTotalDollarsOrigJP = (entrance_fee + holiday_fee + transfer_fee + remittance_fee + sub_total + custom1_fee) - discount;
        totalInvoiceDollarsOrigJP = ((entrance_fee + holiday_fee + transfer_fee + remittance_fee + sub_total + custom1_fee) - (commission + discount));

        totalAgentJP = ((entrance_fee + holiday_fee + transfer_fee + remittance_fee + sub_total + custom1_fee) - (commission + discount)) - ((rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_plan_upgrade_fee + rfd_tuition_accommodation_fee + rfd_other1_fee + rfd_other2_fee) - (rfd_agent_commission + rfd_discount));
        totalDirectJP = (entrance_fee + holiday_fee + transfer_fee + remittance_fee + sub_total + custom1_fee - discount) - (rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_plan_upgrade_fee + rfd_tuition_accommodation_fee + rfd_other1_fee + rfd_other2_fee - rfd_discount);

        totalAgentJPRefund = ((rfd_alltotal_amount_percentage == 0)? (((entrance_fee + holiday_fee + transfer_fee + remittance_fee + custom1_fee + sub_total) - (commission + discount)) -
            ((rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_tuition_accommodation_fee + rfd_plan_upgrade_fee + rfd_other1_fee + rfd_other2_fee) - (rfd_agent_commission + rfd_discount))) - rfd_totalamount_input : rfd_alltotal_amount_discount);
        totalDirectJPRefund = ((rfd_alltotal_amount_percentage == 0)? (((entrance_fee + holiday_fee + transfer_fee + remittance_fee + custom1_fee + sub_total) - (discount)) -
            ((rfd_entrance_fee + rfd_holiday_fee + rfd_room_upgrade_fee + rfd_tuition_accommodation_fee + rfd_plan_upgrade_fee + rfd_other1_fee + rfd_other2_fee) - (rfd_discount))) - rfd_totalamount_input : rfd_alltotal_discount_student);

        refundType = (rfd_alltotal_amount_percentage == 0)?currency+rfd_totalamount_input:rfd_alltotal_amount_percentage+'%';
        ...
        for (i = 0, len = invoiceDiscountList.length, discountValueDollarsOrig = ""; i < len; i++) {
            discountValueDollarsOrig += "-" + currency + invoiceDiscountList[i]['discount'] + "<br>";
        }
        ...
        for (i = 0, len = refundDiscountList.length, discountValueDollars = ""; i < len; i++) {
            discountValueDollars += "-" + currency + refundDiscountList[i]['discount'] + "<br>";
        }
        ...
        else if (rfd_accommodation_id == '9') {
        ...
        let displayBillLabel = '';
        if(country_code == 'CN'){
            displayAgencyName = "AGENCY'S";
            displayBillLabel = 'STUDENT NAME:'
        } else {
            displayBillLabel = 'This is to bill';
            displayAgencyName = '';
        }
        ...
        for (i = 0, len = reservedRoomsList.length, reservedAccomoRoomtype = ""; i < len; i++) {
            ...
            const checkoutDate = Date.parse(moment(this.saveDataLoadEvent.selectCheckOut_date.jsdate).format('YYYY-MM-DD'));
            const from = Date.parse(reservedRoomsList[i]['date_from']);
            if (from < checkoutDate) {
                reservedAccomoRoomtype += (new Date(reservedRoomsList[i]['date_from']).getMonth() + 1) + "/" + new Date(reservedRoomsList[i]['date_from']).getDate() + "-" + (new Date(reservedRoomsList[i]['date_to']).getMonth() + 1) + "/" + new Date(reservedRoomsList[i]['date_to']).getDate()
                    + (reservedRoomsList[i]['building_id']==1?' ITP ':' SFC ')
        ...
        for (i = 0, len = reservedCondoRoomsList.length, reservedAccomoCondoRoomtype = ""; i < len; i++) {
            ...
            reservedAccomoCondoRoomtype += (new Date(reservedCondoRoomsList[i]['date_from']).getMonth() + 1) + "/" + new Date(reservedCondoRoomsList[i]['date_from']).getDate() + "-" + (new Date(reservedCondoRoomsList[i]['date_to']).getMonth() + 1) + "/" + new Date(reservedCondoRoomsList[i]['date_to']).getDate()
                + (reservedCondoRoomsList[i]['building_id']==1?' ITP ':' SFC ')
                + accomoCondoName + "<br>";
        }
        ...
        for (i = 0, len = reservedHotelsRoomsList.length, reservedAccomoHotelsRoomtype = ""; i < len; i++) {
            ...
            reservedAccomoHotelsRoomtype += (new Date(reservedHotelsRoomsList[i]['date_from']).getMonth() + 1) + "/" + new Date(reservedHotelsRoomsList[i]['date_from']).getDate() + "-" + (new Date(reservedHotelsRoomsList[i]['date_to']).getMonth() + 1) + "/" + new Date(reservedHotelsRoomsList[i]['date_to']).getDate()
                + (reservedHotelsRoomsList[i]['building_id']==1?' ITP ':' SFC ')
                + accomoCondoName + "<br>";
        }
        ...
        for (i = 0, len = reservedWalkinRoomsList.length, reservedAccomoWalkinRoomtype = ""; i < len; i++) {
            ...
            reservedAccomoWalkinRoomtype += (new Date(reservedWalkinRoomsList[i]['date_from']).getMonth() + 1) + "/" + new Date(reservedWalkinRoomsList[i]['date_from']).getDate() + "-" + (new Date(reservedWalkinRoomsList[i]['date_to']).getMonth() + 1) + "/" + new Date(reservedWalkinRoomsList[i]['date_to']).getDate()
                + (reservedWalkinRoomsList[i]['building_id']==1?' ITP ':' SFC ')
                + accomoCondoName + "<br>";
        }
        ...
        if(selectInvoice == 0) {
            ...
            popupWin.document.write(`
             <html>
             <title>RFD_INVOICE-${refund_invoice_number}_AGENT</title>
             <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
              ...
              <body onload="window.print();window.close()">
                ...
                float:right; margin-left:45%;margin-right:11%;outline-style: solid;margin-bottom: 30px;" border="0"
                    ...
                    <tr style="line-height: 30px;">
                        ...
                        <td style="border-top: 1px solid #000;" colspan="2"><b>YEN:</b></td>
                        <td style="border-top: 1px solid #000;">
                            <div style="width:100%;text-align: center">
                                <span style="font-size: 16pt;font-weight: bolder">
                                    <b>¥${totalInvoiceDollarsOrigJP}</b>
                                </span>
                            </div>
                        </td>
                    </tr>
                ...
                <table frame="box" style="width:80%;text-align: center;font-size: 13pt;font-weight: bolder;
                float:right; margin-left:45%;margin-right:11%;outline-style: solid;margin-bottom: 1px;" border="0">
                    <tr style="font-size: 16pt;line-height: 30px;">
                        <th style="text-align: center;border-bottom: 1px solid #000;">Description</th>
                        <th style="text-align: center;border-bottom: 1px solid #000;">Unit Price</th>
                        <th style="text-align: center;border-bottom: 1px solid #000;">Pax</th>
                    ...
                    <tr>
                        <td>Tuition & Accommodation<br>
                        <span style="font-size:12pt;">${checkIn.getMonth()+1}/${checkIn.getDate()}-${checkOut.getMonth()+1}/${checkOut.getDate()}
                        ${accommodationType}
                        ${roomType}
                        ${rfd_course}
                        </span>
                ...
                <table style="width:80%;text-align: center;font-size: 14pt;font-weight: bolder; float:right; margin-left:45%;margin-right:11%;margin-bottom: 5px;" border="0">
                    ...
                    <tr style="color: red">
                        <td>
                            Refund(${refundType})<br>
                            <span style="font-size: 10pt;font-weight: bolder">${rfd_refund_reason}</span>
                        </td>
                        <td colspan="3">
                            <div style="width:100%;text-align: center">
                            <span style="font-size: 13pt;font-weight: bolder">
                                <b>${totalAgentJPRefund}</b>
                            </span>
                            </div>
                        </td>
                    </tr>
            ...
            popupWin.document.close();
        } else if(selectInvoice == 1) {
            printContentsConfirmationPage = document.getElementById('print-non-jp-invoice-dollars').innerHTML;
            popupWin = window.open('', '_blank', 'top=0,left=0,height=100%,width=auto');
            popupWin.document.open();
            popupWin.document.write(`
             <html>
             <title>RFD_INVOICE-${refund_invoice_number}_DIRECT</title>
             <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
            ...
            popupWin.document.close();
        } else if(selectInvoice == 2) {
            printContentsConfirmationPage = document.getElementById('print-non-jp-invoice-dollars').innerHTML;
            popupWin = window.open('', '_blank', 'top=0,left=0,height=100%,width=auto');
            popupWin.document.open();
            popupWin.document.write(`
             <html>
             <title>RFD_INVOICE-${refund_invoice_number}</title>
             <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
              ...
              <body onload="window.print();window.close()">
                ...
                <div style="width:100%;text-align: center;font-size: 14pt">
                    <tr>
                        <td style="text-align: center;font-size: 14pt;font-weight: bolder;">${displayAgencyName} INVOICE</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;font-size: 14pt;font-weight: bolder;">
                            ${displayBillLabel} ${salutation} ${passport_name}
                        </td>
                    </tr>
                </div>
                <div style="width:100%;text-align: left;margin-left:5em;font-size: 13pt"> for the following breakdown:</div>
            ...
            popupWin.document.write(`
               ...
               <table style="width:80%;margin-bottom: 25px;font-size:14pt;">
                <tr align="center">
                   <td colspan="2" style="font-size:18pt;font-weight: bolder;border-bottom:1px solid black">Refund</td>
               </tr>
               <tr>
               ...
               <tr style="font-size:14pt;font-weight: bolder">
                   ...
                   <td align="center" style="border-bottom: 1px solid #000;">${phRateInvoice}</td>
                   <td>PHP</td>
               </tr>
               </table>
               </div>
               <div align="center">
                <table style="width:80%;border-collapse: collapse;border: 1px solid black;margin-bottom:30px;">
                    <tr class="darkgray">
                    ...
                    <tr class="darkgray">
                        <td colspan="2" align="left">Total（Tax inc.）</td>
                        <td align="right">PHP</td>
                        <td align="center" style="border:1px solid black;">${phRateInvoice}</td>
                    </tr>
                </table>
                <table style="width:80%;border-collapse: collapse;margin-bottom:70px;">
                    <tr>
                        <td colspan="3" align="left" style="border-bottom:1px solid black;font-size:15pt;font-weight:bolder">
                            For cash refund
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="border: 1px solid black;">Student's Name</td>
                        <td align="center" style="border: 1px solid black;">Amount</td>
                        <td align="center" style="border: 1px solid black;">Student's Signature</td>
                    </tr>
                    <tr style="font-weight: bolder">
                        <td align="center" style="border: 1px solid black;padding: 20px 20px 20px">${passport_name}</td>
                        <td align="center" style="border: 1px solid black;padding: 20px 20px 20px">${phRateInvoice}</td>
                        <td align="center" style="border: 1px solid black;padding: 20px 20px 20px"></td>
                    </tr>
                </table>
               </div> 
          </body>
    ...
    public printExtInvoice(country_code, gender, agent_name, passport_name, ext_invoice_number, ext_checkin_date, ext_checkout_date, ext_term, ext_building_id,
                           ...
                           ext_adjustments_php,ext_isInvoiceConfirmed,ext_commission_percentage,invoiceDiscountList,ext_discount,phRateInvoice,selectInvoice,ext_entrance_date,
        ext_graduation_date, ext_due_date, id_number, age, flight_no, memo, domi_info_campus, reservedRoomsListExtend) {

        let printContentsConfirmationPage, popupWin, roomType, printContentsInvoicePage,printContentsInvoiceSecondPage;
        let arrivalDate, arrivalTime, cleanArriveTime, checkIn, checkOut, accommodationType, salutation, gndr, entranceDate, gradDate, dueDate, displayAgentName, arrival_time;
        let subTotalNonJPDollars, totalInvoiceNonJPDollars,discountReason,discountValueYen,discountValueDollars,i,len;
        let subTotalJPYen, subTotalNonJPYen,totalInvoiceJPYen,totalInvoiceNonJPYen;
        let accomoName, reservedAccomoRoomtype;
        ...
        subTotalJPYen = (ext_entrance_fee + ext_tuition_accommodation_fee + ext_other1_fee + ext_other2_fee + ext_holiday_fee + ext_room_upgrade_fee + ext_plan_upgrade_fee) - ext_discount;
        subTotalNonJPYen = (ext_tuition_accommodation_fee + ext_entrance_fee + ext_other1_fee + ext_other2_fee + ext_holiday_fee + ext_room_upgrade_fee + ext_plan_upgrade_fee);

        totalInvoiceJPYen = (ext_tuition_accommodation_fee + ext_entrance_fee + ext_room_upgrade_fee + ext_plan_upgrade_fee + ext_other1_fee + ext_other2_fee + ext_holiday_fee) - (ext_discount + ext_agent_commission);
        totalInvoiceNonJPYen = (ext_tuition_accommodation_fee + ext_entrance_fee + ext_room_upgrade_fee + ext_plan_upgrade_fee + ext_other1_fee + ext_other2_fee + ext_holiday_fee) - (ext_discount);
        ...
        entranceDate = new Date(ext_entrance_date);
        gradDate = new Date(ext_graduation_date);

        if(ext_checkin_date == '1900-01-01 00:00:00') {
            cleanArriveTime = '';
        } else {
            arrivalTime = new Date(ext_checkin_date);
            cleanArriveTime = arrivalTime.toLocaleTimeString().replace(/:(\d{2}) (?=[AP]M)/, " ");
        }
        if(ext_due_date == '1900-01-01 00:00:00') {
            dueDate = '';
        } else {
            dueDate = new Date(ext_due_date).toLocaleDateString('en-US');
        }
        dueDate = new Date(ext_due_date);
        arrivalDate = new Date(ext_checkin_date);
        ...
        else if (ext_accommodation_id == '9') {
            accommodationType = 'Condo'
        }
        ...
        /*Dormitory Rooms*/
        for (i = 0, len = reservedRoomsListExtend.length, reservedAccomoRoomtype = ""; i < len; i++) {
            if (reservedRoomsListExtend[i]['accommodation_name'] == '1') {
                accomoName = 'Share House'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '4') {
                accomoName = 'Share Room'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '5') {
                accomoName = 'Executive Room'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '6') {
                accomoName = 'Deluxe Room'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '7') {
                accomoName = 'Walk In'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '8') {
                accomoName = 'Walk In'
            } else if (reservedRoomsListExtend[i]['accommodation_name'] == '-1') {
                accomoName = 'Walk In'
            }
            const to = Date.parse(reservedRoomsListExtend[i]['date_to']);
            const checkinDateExt = Date.parse(this.extensionInvoice.ext_checkin_date);
            const checkoutDateExt = Date.parse(this.extensionInvoice.ext_checkout_date);
            if ((to <= checkoutDateExt) && (to >= checkinDateExt) ) {
                reservedAccomoRoomtype += (new Date(reservedRoomsListExtend[i]['date_from']).getMonth() + 1) + "/" + new Date(reservedRoomsListExtend[i]['date_from']).getDate() + "-" + (new Date(reservedRoomsListExtend[i]['date_to']).getMonth() + 1) + "/" + new Date(reservedRoomsListExtend[i]['date_to']).getDate()
                    + (reservedRoomsListExtend[i]['building_id'] == 1 ? ' ITP ' : ' SFC ')
                    + accomoName + " (" + (reservedRoomsListExtend[i]['room_type'].toUpperCase()) + ") " + "<br>";
            }
        }
        ...
        if(selectInvoice == 0) {
            ...
            popupWin.document.write(`
             <html>
             <title>EXT-INVOICE-${ext_invoice_number}-AGENT</title>
             <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
              ...
              <body onload="window.print();window.close()">
                ...
                float:right; margin-left:45%;margin-right:11%;outline-style: solid;margin-bottom: 30px;" border="0">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;border-bottom: 1px solid #000;">${ext_course}</td>
                        <td style="text-align: left;border-bottom: 1px solid #000;">${ext_term} week(s)/day(s)</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;border-bottom: 1px solid #000;">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;border-bottom: 1px solid #000;">${ext_building_id==1?'ITP':'SFC'}</td>
                        <td style="text-align: left;border-bottom: 1px solid #000;">&nbsp;</td>
                    </tr>
                    <tr>
                ...
                <div style="text-align: right;font-size: 13pt;width: 55%; float:right"><span style="margin-right:2em">Invoice number</span> <br>
                     <b><span style="margin-right:2em;font-size: 13pt">${ext_invoice_number}</span></b>
                </div>
                ...
                <div style="text-align: right;font-size: 13pt;width: 55%; float:right;margin-bottom:5px;">
                    ...
                    <b><span style="margin-right:5em">${dueDate.toLocaleDateString('en-US')}</span></b>
                </div>
                <table frame="box" style="width:80%;text-align: center;font-size: 12pt;
                    ...
                    <tr>
                     ...
                     <tr style="color:red">
                         <td>Commission ${ext_commission_percentage?ext_commission_percentage.toFixed(0):''}${ext_commission_percentage?'%':''} of *Tuition</td>
                         <td></td>
                  ...
                  <div style="float:left">
                        ...
                        <table frame="box" style="margin-left:4em;text-align: center;font-size: 12pt;font-weight: bolder;
                            ...
                            <tr>
                                <td>SSP</td>
                                <td>Php ${ext_ssp_fee_php}</td>
                            </tr>
                            <tr>
                                <td>Student ID</td>
                                <td>Php ${ext_student_id_card_php}</td>
                            </tr>
                            <tr>
                                <td>Electricity Fee</td>
                                <td>Php ${ext_electrical_fee_php}</td>
                            </tr>
                            <tr>
                                <td>I-Card</td>
                                <td>Php ${ext_i_card_fee_php}</td>
                            </tr>
                            <tr>
                                <td>ECC</td>
                                <td>Php ${ext_ecc_php}</td>
                            </tr>
                            <tr>
                                <td>Extension Fee</td>
                                <td>Php ${ext_extention_fee_php}</td>
                            </tr>
                        </table>
                  </div>
                 ...
                 <div style="width: 55%; float:right">
                        <div style="text-align: left;font-size: 11pt;font-weight: bold">
                            ...
                            <span style="margin-left:5em">Due date ${dueDate.toLocaleDateString('en-US')}<br></span>
                        </div>
                 </div>
              </body>
              `);
            ...
            popupWin.document.write(`
            <html>
            <title>EXT_INVOICE-${ext_invoice_number}-DIRECT</title>
            <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
            ...
            <table frame="box" style="width:80%;text-align: center;font-size: 13pt;
                ...
                <tr>
                    <td>
                        <span style="color:red;">*</span>Tuition Fee<br>
                        <span style="font-size:12pt;">${checkIn.getMonth()+1}/${checkIn.getDate()}-${checkOut.getMonth()+1}/${checkOut.getDate()}
                            ${accommodationType}
                            ${roomType}
                            ${ext_course}
            ...
            popupWin.document.write(`
             <html>
             <title>EXT_INVOICE-${ext_invoice_number}</title>
             <head>
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <style>
                     @media print{
            ...
            popupWin.document.write(`
             ...
             <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
              ...
              <body onload="window.print();window.close()">
                ...
                <table style="width:100%;text-align: center;font-size: 14pt;font-weight: bolder;">
                    <tr>
                        <td style="text-align: center;font-size: 14pt;font-weight: bolder;">${displayAgencyName} INVOICE</td>
                    </tr>
                    <tr>
