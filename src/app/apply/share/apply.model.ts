...
export class ExportFilterModel {
    ...
    public rfd_all_total_discount: number;
    public rfd_alltotal_amount_percentage: number;
    public rfd_alltotal_discount_student: number;
    public rfd_refund_reason: string;
    public rfd_totalamount_input: number;
...
export class ExtensionInvoiceModel {
    ...
    public ext_entrance_date: string;
    public ext_graduation_date: string;
    public ext_due_date: string;
    ...
    public ext_filename: string;
    public ext_filesize: string;
    public ext_uploaded_by: string;
    public ext_uploaded_date: string;
...
export class RefundInvoiceModel {
    ...
    public rfd_filename: string;
    public rfd_filesize: string;
    public rfd_uploaded_by: string;
    public rfd_uploaded_date: string;
